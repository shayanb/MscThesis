...
\fixme{add a short scenario when it was obvious that the system needed to have an interface for the blockchain confirmation}
...
\begin{figure}[h]
\centering
\includegraphics{fig/Mycelium_gear}
...
\begin{figure}[h]
\centering
\includegraphics{fig/bitsci_screen}
...
\begin{figure}[h]
\centering
\includegraphics{fig/First_View.png}
...
\begin{figure}[h]
\centering
\includegraphics{fig/Payment.png}
  \caption{PoS - Payment}
\label{fig:payment}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{fig/report_page.png}
  \caption{Report Page}
...
\begin{figure}[h]
\centering
\includegraphics{fig/canceled_sale.png}
...
\begin{figure}
\centering
\includegraphics{fig/complete_sale.png}
...
This PoS has been made open source and available to public\footnote{\url{https://github.com/shayanb/Bitcoin-PoS-PHP}} and has already been used in other small businesses to accept bitcoin.
...
\begin{figure}[h]
\centering
\includegraphics{fig/Payment_manual.pdf}
...
%FIXME: future work: fast verification

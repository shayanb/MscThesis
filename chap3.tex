...
Depending on the requirements, it's possible to use integration of some open source software to build a fully custom self-managed Bitcoin PoS. The details of this custom PoS will be discussed in section ~\ref{Design and Implementation} and the scoring is discussed in ~\ref{Implementation measurements}.

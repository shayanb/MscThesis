...
\textbf{Thesis Statement:} End-to-end usable payment \fixme{system} using Bitcoin, and its components, can be designed for real-world deployability while maintaining a strong notion of usability and security.

...
\setchapterpreamble{This chapter is adapted from published work Supervised by Dr. Jeremy Clark and co-authored by David Barrera and Elizabeth Stobert ~\cite{eskandari2015first}}
% = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =

\section{Introductory Remarks}

\fixme{move these to intorduction! }
...
\begin{figure}[pt]
  \includegraphics[width=.50\textwidth]{fig/paperwallet.png}

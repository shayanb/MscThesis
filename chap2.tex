...
It should be mentioned that the framework that was used in this chapter, is being considered a framework to evaluate Bitcoin wallet clients and might not be usable for other Bitcoin related softwares.
